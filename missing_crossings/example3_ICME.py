...
start = dt.datetime(year=2013, month=8, day=20, hour=6, minute=0)
end = dt.datetime(year=2013, month=8, day=21, hour=18, minute=0)
...
for ax in [mag_axis, fips_axis]:
    ...
    ax.tick_params(which="minor", length=8, width=0.8)

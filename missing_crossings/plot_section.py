...
start = dt.datetime(year=2012, month=4, day=23, hour=0, minute=0)
end = dt.datetime(year=2012, month=4, day=23, hour=23, minute=59)
...
fips_axis = plt.subplot2grid((3, 2), (2, 0), colspan=2)
mag_axis = plt.subplot2grid((3, 2), (1, 0), colspan=2, sharex=fips_axis)
xy_axis = plt.subplot2grid((3, 2), (0, 0), colspan=1)
xz_axis = plt.subplot2grid((3, 2), (0, 1), colspan=1)
